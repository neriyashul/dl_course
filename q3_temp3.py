...
training_normal_images, train_images_to_compare = add_augmentations(training_normal_images)

################################################################################################
#train_images_to_compare = train_images
...
autoencoder_history = autoencoder.fit(training_normal_images, train_images_to_compare,
...
def display_distances():
    training_normal_images_latent_3d = np.squeeze(training_normal_images_enc, axis=-1)
    training_normal_images_latent_mean_image = np.mean(training_normal_images_latent_3d, axis=0)

    training_pneumonia_images_latent_3d = np.squeeze(training_pneumonia_images_enc, axis=-1)
    test_normal_images_latent_3d = np.squeeze(test_normal_images_enc, axis=-1)
    test_pneumonia_images_latent_3d = np.squeeze(test_pneumonia_images_enc, axis=-1)

    # Calculate the distance of each image from the mean image
    training_normal_images_distances = np.sqrt(np.sum((training_normal_images_latent_3d - training_normal_images_latent_mean_image) ** 2, axis=(1, 2)))
    training_normal_images_distances.sort()
    training_pneumonia_images_distances = np.sqrt(np.sum((training_pneumonia_images_latent_3d - training_normal_images_latent_mean_image) ** 2, axis=(1, 2)))
    training_pneumonia_images_distances.sort()
    test_normal_images_distances = np.sqrt(np.sum((test_normal_images_latent_3d - training_normal_images_latent_mean_image) ** 2, axis=(1, 2)))
    test_normal_images_distances.sort()
    test_pneumonia_images_distances = np.sqrt(np.sum((test_pneumonia_images_latent_3d - training_normal_images_latent_mean_image) ** 2, axis=(1, 2)))
